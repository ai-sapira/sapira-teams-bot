  ...
  async createTicketFromConversation(conversation, proposal, conversationReference = null) {
    try {
      ...
      const requestBody = {
        ...
        ai_analysis: {
          title: proposal.title, // Título del proyecto (2-3 palabras)
          ...
          business_unit: proposal.business_unit, // Business Unit inferido por AI
          project: proposal.project, // Project inferido por AI
